...
public class Method03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("0부터 99까지 정수 만들기");
		for(int i = 0; i < 10; i++) {
		...
		for(int i = 0; i < 10; i++) {
			...
			System.out.println("0부터 9까지 정수 만들기 " + intNum);
		}
		System.out.println("1부터 100까지 정수 만들기");
		for(int i = 0; i < 10; i++) {
			int intNum =(int)(Math.random()*100+1);
			System.out.println(intNum);
	}
	System.out.println("10부터 109까지 정수 만들기");
	for(int i = 0; i < 10; i++) {
		...
		public static void makeStars(int intStars) {
			...
			System.out.println("500부터 100까지 정수 만들기");
			for(int i = 0; i < 10; i++) {
...
/*}
		...
		System.out.println("50부터 100까지 정수 만들기");
		for(int i = 0; i < 10; i++) {
